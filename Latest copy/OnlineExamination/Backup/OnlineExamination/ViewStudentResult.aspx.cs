    ...
    public partial class ViewStudentResult : System.Web.UI.Page
    {
        ...
        private void BindStudentDetails()
        {
            if (Session["StudentID"] != null)
            {
                ...
                string sQuery = "select a.StudentName,a.MobileNumber,a.Address,a.CourseId,b.CourseName from StudentDetails a join CourseDetails b on a.CourseId=b.CourseId where StudentId=" + studentId;
