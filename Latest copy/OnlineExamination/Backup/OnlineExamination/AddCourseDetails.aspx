...
<tr>
<td style="color: #000000; " align="left">HOD Name</td>
<td>
    <asp:TextBox ID="txtHODName" runat="server" Width="200px"></asp:TextBox>
    </td>
</tr>
<tr>
<td align="left" class="style2" style="color: #000000"></td>
<td class="style2">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ControlToValidate="txtHODName" ErrorMessage="Enter HOD Name" ForeColor="Red"></asp:RequiredFieldValidator>
    </td>
</tr>
<tr>
<td style="color: #000000; " align="left">Course Fees</td>
<td>
    <asp:TextBox ID="txtCourseFees" runat="server" Width="200px"></asp:TextBox>
    </td>
</tr>
<tr>
<td style="color: #000000; " align="left">&nbsp;</td>
<td>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ControlToValidate="txtCourseFees" ErrorMessage="Enter Course Fees" 
        ForeColor="Red"></asp:RequiredFieldValidator>
    </td>
</tr>
<tr>
    ...
    <asp:Button ID="btnReset" runat="server" Text="Reset" Width="100px" 
        ...
        <asp:Panel ID="pnlViewCourse" runat="server">
            <asp:GridView ID="gvCourseDetails" runat="server" AutoGenerateColumns="False" 
                CellPadding="4" ForeColor="#333333" Width="600px" DataKeyNames="CourseId" 
                ...
                <Columns>
                    <asp:BoundField DataField="CourseName" HeaderText="Course_Name" 
                        ReadOnly="True" />
                    <asp:BoundField DataField="HODName" HeaderText="HOD_Name" ReadOnly="True" />
                    <asp:BoundField DataField="CourseFees" HeaderText="Course_Fees" 
                        ReadOnly="True" />
